...
In the next step K-Means Clustering is applied. Following are the steps for this process:

![k_means_1](https://github.com/LarsTinnefeld/olist_ecom_analysis/blob/main/Images/k_means_code_1.PNG?raw=true)

![k_means_2](https://github.com/LarsTinnefeld/olist_ecom_analysis/blob/main/Images/k_means_code_2.PNG?raw=true)

The Sum of Squared Errors (SSE) qantifies the confidence of the result.
